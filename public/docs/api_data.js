define({ "api": [
  ...
  },
  {
    ...
    "title": "Request to get (currentValue / goal)",
    "name": "GetGoalRatio",
    "group": "Exercise/Goal",
    "version": "1.0.0",
    "header": {
    ...
    "groupTitle": "Exercise/Goal"
  },
  {
    "type": "get",
    "url": "/api/v1/goal",
    "title": "Request to get My Goal",
    "name": "GetMyGoal",
    "group": "Exercise/Goal",
    "version": "1.0.0",
    "header": {
  ...
  },
  {
    "type": "patch",
    "url": "/api/v1/goal",
    "title": "Request to patch(update) My Goal",
    "name": "PatchMyGoal",
    "group": "Exercise/Goal",
    "version": "1.0.0",
    "header": {
    ...
    "body": [
      {
        ...
        "optional": false,
        "field": "calorie",
        "description": "<p>user's goal exercise: calorie</p>"
      },
      {
        "group": "Body",
        "type": "Number",
        "optional": false,
        "field": "km",
        "description": "<p>user's goal exercise: running km</p>"
      },
      {
        "group": "Body",
        "type": "Number",
        "optional": false,
        "field": "time",
        "description": "<p>user's goal exercise: time (sec)</p>"
      }
    ],
    "success": {
      "fields": {
  ...
  },
  {
    ...
    "title": "Request to patch user's score",
    "name": "PatchScore",
    "group": "Exercise",
    "version": "1.0.0",
    "header": {
        ...
        "Success 200": [
          {
            ...
            "optional": false,
            "field": "score",
            "description": "<p>your the highest score</p>"
          }
        ]
      },
      "examples": [
